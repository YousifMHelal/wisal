        ...
        <ResponsiveContainer width="100%" height="100%">
          ...
          >
            ...
            <YAxis
              ...
              tickLine={false}
              axisLine={false}
              tick={(props) => <RtlYTick x={typeof props.x === "number" ? props.x : undefined} y={typeof props.y === "number" ? props.y : undefined} payload={props.payload as { value: string } | undefined} width={isAr ? 165 : 135} isAr={isAr} />}
            />
            <Tooltip
              contentStyle={{
                background: "var(--card)",
